...
def open_popup1():
    ...
    link1 = tk.Label(top, text= "https://www.pygame.org/contribute.html", font=('Segoe UI', 10), bg="white", fg="black")
    ...
    tk.Label(top, text= "Tämä ohjelma on avoimen lähdekoodin.", font=('Segoe UI', 10), bg="white", fg="black").place(x=0,y=60)
    link2 = tk.Label(top, text= "https://github.com/TheDoubleMix/PygameBingo", font=('Segoe UI', 10), bg="white", fg="black")
